...
import { Mail, Lock, ArrowRight, BarChart3, Zap, Sparkles, ShieldCheck, ArrowLeft } from "lucide-react";
    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12" style={{ backgroundColor: "#0f172a" }}>
        ...
        <div className="space-y-8">
          <h3 className="text-3xl font-extrabold leading-tight" style={{ color: "#fff" }}>
            Gérez votre catalogue<br />
            <span style={{ color: "#60a5fa" }}>10x plus vite</span>
          </h3>
          <div className="space-y-5">
            {[
              { icon: BarChart3, title: "Modification en masse", desc: "Prix, titres, tags — modifiez des centaines de produits en un clic" },
              { icon: Sparkles, title: "IA intégrée", desc: "Génération automatique de titres et descriptions SEO optimisés" },
              { icon: Zap, title: "Automatisations", desc: "Créez des règles pour piloter votre catalogue automatiquement" },
              { icon: ShieldCheck, title: "Sécurisé", desc: "Connexion OAuth Shopify, données chiffrées, RGPD compliant" },
            ].map((f) => {
              const Icon = f.icon;
              return (
      ...
      <div className="flex-1 flex items-center justify-center p-8" style={{ backgroundColor: "#f8fafc" }}>
        <div className="w-full max-w-md">
          ...
          <h1 className="text-2xl font-extrabold mb-2" style={{ color: "#0f172a" }}>Bon retour 👋</h1>
          <p className="text-sm mb-8" style={{ color: "#64748b" }}>Connectez-vous pour accéder à votre tableau de bord</p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs font-medium hover:underline" style={{ color: "#2563eb" }}>Mot de passe oublié ?</Link>
              </div>
              <div className="relative">
          ...
          <p className="mt-6 text-center text-sm" style={{ color: "#64748b" }}>
            ...
            <Link href="/signup" className="font-medium hover:underline" style={{ color: "#2563eb" }}>Créer un compte</Link>
          </p>
