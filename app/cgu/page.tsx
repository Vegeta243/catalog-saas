        ...
        <div className="prose-content space-y-6 text-sm leading-relaxed" style={{ color: "#374151" }}>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>Le paiement est effectué via Stripe (carte bancaire) ou PayPal.</li>
              <li>Un essai gratuit de 7 jours est proposé pour les plans payants.</li>
              <li>L&apos;Utilisateur peut annuler son abonnement à tout moment. L&apos;accès reste actif jusqu&apos;à la fin de la période facturée.</li>
