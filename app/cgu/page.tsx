        ...
        <div className="prose-content space-y-6 text-sm leading-relaxed" style={{ color: "#374151" }}>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>Un plan gratuit avec 100 actions IA est disponible sans carte bancaire. Les plans payants donnent accès à des volumes d&apos;actions supérieurs et des fonctionnalités avancées.</li>
