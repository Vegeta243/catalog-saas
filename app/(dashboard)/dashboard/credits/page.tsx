...
const PLAN_META: Record<string, { name: string; icon: typeof Zap; color: string; bg: string; features: string[] }> = {
  ...
  starter: { name: "Starter", icon: Zap,    color: "#2563eb", bg: "#eff6ff",  features: ["1 1 500 actions/mois", "1 boutique", "Modification en masse", "Support email"] },
  ...
  return (
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const nextPlans = ["free", "starter", "pro", "agency"];
