        ...
        <div className="space-y-4">
          ...
          <ol className="space-y-3">
            {[
              ...
              <li key={i} className="flex items-start gap-3 text-sm" style={{ color: "var(--text-secondary)" }}>
                <span className="w-5 h-5 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold" style={{ backgroundColor: "#dbeafe", color: "#93c5fd" }}>{i + 1}</span>
                <span>{step}</span>
              </li>
            ))}
          </ol>
          <div className="rounded-xl overflow-hidden border border-gray-200">
            <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
              <span className="text-xs font-mono" style={{ color: "var(--text-tertiary)" }}>.env.local</span>
        ...
        <div className="space-y-4">
          ...
          {autoSetupStatus === "success" && priceIds && envSnippet && (
            <div className="space-y-3">
              ...
              <div className="rounded-xl overflow-hidden border border-gray-200">
                <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
                  <span className="text-xs font-mono" style={{ color: "var(--text-tertiary)" }}>.env.local — Price IDs</span>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div>
            <p className="text-sm font-semibold mb-2" style={{ color: "var(--text-secondary)" }}>En développement (Stripe CLI) :</p>
            <div className="rounded-xl overflow-hidden border border-gray-200">
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-900">
                <Terminal className="w-3.5 h-3.5" style={{ color: "var(--text-tertiary)" }} />
                <span className="text-xs font-mono" style={{ color: "var(--text-tertiary)" }}>Terminal</span>
              </div>
...
stripe listen --forward-to localhost:3000/api/stripe/webhook`}
          ...
          <div>
            <p className="text-sm font-semibold mb-2" style={{ color: "var(--text-secondary)" }}>En production :</p>
            ...
            {[
              ...
              <div key={item.label} className="flex items-center justify-between p-3 rounded-lg border border-gray-100 bg-gray-50">
                ...
                <div className="flex items-center gap-2">
                  <code className="text-xs" style={{ color: "var(--text-primary)" }}>{item.value}</code>
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-2" style={{ color: "var(--text-primary)" }}>Guide de configuration</h1>
        <p className="text-sm" style={{ color: "var(--text-tertiary)" }}>
      ...
      <div className="mt-8 p-5 rounded-2xl border border-blue-200 bg-blue-50">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold mb-1" style={{ color: "#93c5fd" }}>Mode démo actif</p>
