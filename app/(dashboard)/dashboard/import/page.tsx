...
function detectPlatform(url: string) {
  ...
  if (u.includes('cjdropshipping')) return { name: 'CJDropshipping', color: '#1d4ed8', dot: '#3b82f6' }
  ...
  if (url.startsWith('http'))        return { name: 'Site web',        color: '#475569', dot: '#6b7a99' }
  return null
}
...
export default function ImportPage() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 860, margin: '0 auto' }}>
      <h1 style={{ color: '#0f172a', fontSize: 22, fontWeight: 700, margin: '0 0 6px', letterSpacing: '-0.01em' }}>
        Import de produits
      </h1>
      <p style={{ color: '#475569', fontSize: 14, margin: '0 0 20px', fontWeight: 400 }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 24 }}>
        {[
          ...
          { name: 'CJDropshipping',  color: '#1d4ed8', dot: '#3b82f6' },
        ...
        <>
          ...
          <div style={card}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
              <p style={{ color: '#0f172a', fontWeight: 500, fontSize: 14, margin: 0 }}>URLs à importer</p>
              {urls.length > 0 && (
                <span style={{
                  background: '#eff6ff',
          ...
          {urls.length > 0 && (
            <div style={card}>
              <p style={{ color: '#0f172a', fontWeight: 500, fontSize: 14, margin: '0 0 10px' }}>Produits détectés</p>
          ...
          <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              <p style={{ color: '#0f172a', fontSize: 14, fontWeight: 500, margin: '0 0 2px' }}>
                Synchroniser avec Shopify
              </p>
              {shopifyOk ? (
                <p style={{ ...lbl, margin: 0, color: '#10b981' }}>Boutique connectée</p>
              ) : (
                <p style={{ ...lbl, margin: 0, color: '#dc2626' }}>
                  Aucune boutique —{' '}
          ...
          {results.length > 0 && (
            <div style={card}>
              <p style={{ color: '#0f172a', fontWeight: 500, fontSize: 14, margin: '0 0 14px' }}>
          ...
          {!urls.length && !results.length && (
            <div style={{ ...card, textAlign: 'center', padding: '40px 24px' }}>
              <p style={{ color: '#0f172a', fontSize: 15, fontWeight: 500, margin: '0 0 6px' }}>Comment importer ?</p>
              <p style={{ color: '#475569', fontSize: 14, fontWeight: 400, margin: '0 0 20px', lineHeight: 1.5 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, maxWidth: 480, margin: '0 auto' }}>
                {[
                  ...
                  { name: 'CJDropshipping', desc: 'cjdropshipping.com/...',  color: '#1d4ed8' },
                  ...
                  <div key={p.name} style={{
                    ...
                    <p style={{ color: '#64748b', fontSize: 11, fontWeight: 400, margin: 0 }}>{p.desc}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <>
          {history.length === 0 ? (
            <div style={{ ...card, textAlign: 'center', padding: '60px 24px' }}>
              <p style={{ color: '#0f172a', fontSize: 15, fontWeight: 500, margin: '0 0 6px' }}>Aucun import</p>
              <p style={{ color: '#475569', fontSize: 14, fontWeight: 400, margin: 0 }}>Votre historique apparaît ici</p>
            </div>
          ) : (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {history.map(job => (
                <div key={job.id} style={{ ...card, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    ...
                    <p style={{ color: '#0f172a', fontSize: 14, fontWeight: 500, margin: 0 }}>
