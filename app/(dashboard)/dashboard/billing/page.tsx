...
const PLAN_INFO: Record<string, { name: string; icon: typeof Zap; price: number; yearlyPrice: number; color: string }> = {
  ...
  starter: { name: "Starter", icon: Zap,    price: 29,  yearlyPrice: 23,  color: "#2563eb" },
  pro:     { name: "Pro",     icon: Crown,  price: 89,  yearlyPrice: 71,  color: "#8b5cf6" },
  scale:   { name: "Scale",   icon: Rocket, price: 129, yearlyPrice: 103, color: "#059669" },
};
