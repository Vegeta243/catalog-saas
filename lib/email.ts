...
// Use onboarding@resend.dev as fail-safe fallback (always works on Resend, no domain verification needed)
const FROM = process.env.RESEND_FROM_EMAIL || 'EcomPilot Elite <onboarding@resend.dev>'
